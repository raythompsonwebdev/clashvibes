...
{
	wp_enqueue_script('clashvibes-block-variations', get_template_directory_uri() . '/js/custom-block-settings.js', array('wp-blocks'), wp_get_theme()->get('Version'));
}
...
function clashvibes_scripts()
{
	...
	if (!is_front_page() || is_category() || is_home()) {
		...
		wp_enqueue_script('sidenav', get_template_directory_uri() . '/js/mobile-sidenav-es6.js', array(), wp_get_theme()->get('Version'));
	}
	...
	wp_enqueue_script('main', get_template_directory_uri() . '/js/main.js', array('jquery'), wp_get_theme()->get('Version'));
