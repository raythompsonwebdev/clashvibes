 ...
 */
$OAUTH2_CLIENT_ID = '402645061513-57np22qpo5e864pedbfg0f3cdbcf0qsm';
$OAUTH2_CLIENT_SECRET = 'fMmVXbsccOgkeFiER8V-KN5z';
...
if ($client->getAccessToken()) {
    ...
    $_SESSION[$tokenSessionKey] = $client->getAccessToken();
} elseif ($OAUTH2_CLIENT_ID == '402645061513-57np22qpo5e864pedbfg0f3cdbcf0qsm') {
    $htmlBody = <<<END
